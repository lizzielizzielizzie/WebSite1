...
<ul class="thumbnails" id="Thumbnails" runat="server">
  <li class="span0">
    <a href="/WebSite1/img/Crancup_StoreFront.jpg" target="_blank"  class="thumbnail"> <!--target="_blank"   TO OPEN IN A NEW TAB  -->
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Crancup_StoreFront.jpg" width="160" />
    </a></li>

     <li class="span0">
    <a href="/WebSite1/img/Fireplace.JPG" target="_blank" class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Fireplace.JPG" width="160" />
    </a>
         </li>
    
     <li class="span0">
    <a href="/WebSite1/img/Vendor.jpg"  target="_blank" class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Vendor.jpg"  width="160"  />
    ...
    <a href="/WebSite1/img/Candels(bigger).JPG" target="_blank"  class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Candels(bigger).JPG" width="160" />
    </a>
         </li>
     <li class="span0">
    <a href="/WebSite1/img/Country Store.JPG" target="_blank"  class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Country Store.JPG" width="160" />
    </a>
         </li>
...
<ul class="thumbnails">
  <li class="span0">
    <a href="/WebSite1/img/flowers.jpg" target="_blank"   class="thumbnail"> <!--target="_blank"   TO OPEN IN A NEW TAB  -->
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/flowers.jpg" width="160" />
    </a></li>
    
    <li class="span0">
    <a href="/WebSite1/img/2013.JPG" target="_blank"  class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/2013.JPG" width="160" />
    </a></li>


      <li class="span0">
    <a href="/WebSite1/img/Bucks.JPG" target="_blank"   class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Bucks.JPG" width="160" />
    </a></li>

      <li class="span0">
    <a href="/WebSite1/img/Elks.JPG" target="_blank"   class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Elks.JPG" width="160" />

    </a></li>

     <li class="span0">
    <a href="/WebSite1/img/Steelers.JPG" target="_blank"   class="thumbnail">
      <img  alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Steelers.JPG" width="160" />
    </a></li>
...
<ul class="thumbnails">
  <li class="span0">
    <a href="/WebSite1/img/Jewelry.jpg" target="_blank"   class="thumbnail"> <!--target="_blank"   TO OPEN IN A NEW TAB  -->
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Jewelry.jpg" width="160" />
    </a></li>

      <li class="span0">
    <a href="/WebSite1/img/Table O'Stuff 2.JPG" target="_blank"   class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Table O'Stuff 2.JPG" width="160" />
    </a></li>

     <li class="span0">
    <a href="/WebSite1/img/Wedding Stuff.JPG" target="_blank"   class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Wedding Stuff.JPG" width="160" />
    </a></li>

    <li class="span0">
    <a href="/WebSite1/img/Angels.JPG" target="_blank"   class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/Angels.JPG" width="160" />
    </a></li>

    <li class="span0">
    <a href="/WebSite1/img/rock.JPG" target="_blank"   class="thumbnail">
      <img alt="Cranberry Cupboard" class="img-rounded" height="200" src="img/rock.JPG" width="160" />
    </a></li>
    </ul>
    <!--
